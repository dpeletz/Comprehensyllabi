...
def GUIMain():
    ...
    rootWin.configure(bg="#87CEEB")


    titleLabel = Label(rootWin, text="Syllabus Simplifier", bg="#9FB6CD", fg="gray1", padx=40, pady=5,
                    font="Verdana 12 bold")
    titleLabel.grid(row=0, column=0)

    label1 = Label(rootWin, text="Import your Syllabus:", bg="#87CEEB", fg="gray1", padx=5, pady=5,
                    font="Verdana 12 bold italic")
    label1.grid(row=1, column=0)

    label2 = Label(rootWin, text="Parse your Syllabus:", bg="#87CEEB", fg="gray1", padx=5, pady=5,
                    font="Verdana 12 bold italic")
    label2.grid(row=3, column=0)

    label3 = Label(rootWin, text="Parsed Text:", bg="#87CEEB", fg="gray1", padx=5, pady=5,
                    font="Verdana 12 bold italic")
    label3.grid(row=5, column=0)

    importButton = Button(rootWin, text="Import", width=7, bg="#A2B5CD", fg="black", activeforeground="#2F4F4F", bd=3,
                    font="Verdana 12 bold", relief=RIDGE, overrelief=SUNKEN, command=importFile)
    importButton.grid(row=2, column=0)

    parseButton = Button(rootWin, text="Parse", width=7, bg="#A2B5CD", fg="black", activeforeground="#2F4F4F", bd=3,
                    font="Verdana 12 bold", relief=RIDGE, overrelief=SUNKEN, command=parseSyllabus)
    parseButton.grid(row=4, column=0)

    quitButton = Button(rootWin, text="Quit", width=7, bg="#A2B5CD", fg="#CD0000", activeforeground="#FF0000", bd=3,
                    font="Verdana 12 bold", relief=RIDGE, overrelief=SUNKEN, command=quit)
    quitButton.grid(row=8, column=0)

    txtEntry = Entry(rootWin, textvariable=parsedTxt, bg="#efefef", fg="black", bd=5, font="Verdana 12",
                     justify=CENTER, relief=SUNKEN, width=20)
    txtEntry.grid(row=6, column=0)

    label4 = Label(rootWin, text="", bg="#87CEEB", fg="gray1", padx=5, pady=0,
                    font="Verdana 12 bold italic")
